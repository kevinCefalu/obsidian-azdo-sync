...
export class AzDOSyncSettingsTab extends PluginSettingTab {
  ...
  private addOrganizationUrlSetting(containerEl: HTMLElement, plugin: AzDOSyncPlugin) {
  ...
  private addPersonalAccessTokenSetting(containerEl: HTMLElement, plugin: AzDOSyncPlugin) {
    new Setting(containerEl)
      .setName("AzDO PAT")
  ...
  private addVerifyConnectionButton(containerEl: HTMLElement, plugin: AzDOSyncPlugin) {
  ...
  private addGetProjectsButton(containerEl: HTMLElement, plugin: AzDOSyncPlugin) {
    ...
    new Setting(containerEl).addButton((btn) => btn
      ...
      .setTooltip("Get a list of projects from Azure DevOps, so you can select which ones to sync")
      .setCta()
